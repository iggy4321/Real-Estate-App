            ...
            <form className="flex flex-col sm:flex-row gap-4">
                <div className="flex flex-col gap-4 flex-1">
                    ...
                    <div className="flex gap-6 flex-wrap">
                        ...
                        <div className="flex gap-2">
                            <input  type="checkbox" id="furnihsed" className="w-5" />
                            <span>Furnished</span>
                        </div>
                        <div className="flex gap-2">
                ...
                <div className="flex flex-col flex-1 gap-4">
                    ...
                    <div className="flex gap-4">
                        <input className="p-3 border border-gray-300 rounded w-full" type="file" id='images' accepts='image/*' multiple />
                        <button className="p-3 text-green-700 border border-green-700 rounded uppercase hover:shadow-lg disabled:opacity-80">Upload</button>
                    </div>
                    <button className="p-3 bg-slate-700 text-white rounded-lg uppercase hover:opacity-95 disabled:opacity-80">Create Lisitng</button>
                </div>
            </form>
        </main>
    )
